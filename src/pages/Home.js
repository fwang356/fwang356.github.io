...
import { FaArrowDown, FaHome, FaSun, FaMoon, FaGithub, FaLinkedin, FaArrowUp } from "react-icons/fa";
    ...
    return (
        <div>
            <VStack p={4} h="full" w="100%">
                ...
                <Stack>
                    <IconButton mb={16} icon={<FaArrowDown />} isRound="true" size={isNotSmallerScreen ? "md" : "sm"} onClick={scrollDown} />
                </Stack>
            </VStack>
